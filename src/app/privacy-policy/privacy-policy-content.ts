    ...
    subSections: [
      {
        ...
        description: 'We use the information we collect to provide the Services, including recording your activities and analyzing your performance.',
      },
      {
        subHeading: 'To customize your experience',
        description: 'We use the information to customize your experience on the Services by suggesting routes, challenges, or clubs that may interest you.'
      },
      {
        subHeading: 'To provide you with targeted promotions',
        description: 'We use the information to serve you with relevant promotions based on your usage and preferences.'
      },
      {
        subHeading: 'To protect you and the Services',
        description: 'We use the information to protect users, enforce our terms, and promote safety.'
      },
      {
        subHeading: 'To assist you with a support request',
        description: 'We use the information to provide support in response to your requests and comments.'
      },
      {
        subHeading: 'To improve our Services',
        description: 'We use the information to analyze, troubleshoot, and improve the Services, including conducting research and using aggregated data.'
      }
    ]
  };
...
export const privacyPolicyContent = [
    ...
    {
      heading: 'Account, Profile, Activity, and Use Information',
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        'We collect and process location information when you sign up for and use the Services. We do not track your device location while you are not using the Services. In order to use our core features, it is necessary for you to permit us to track your device location while you use the Services.'
      ]
    },
    {
      heading: 'Content You Share',
      paragraphs: [
        'We gather information from the photos, videos, posts, comments, and other content you share on the Services, including when you participate in partner events or create segments or routes.'
      ]
    },
    {
    ...
    {
      heading: 'Technical Information and Log Files',
      paragraphs: [
        'We collect technical information from your browser, computer, or mobile device when you access or use the Services. This includes device and network information, cookies, log files, and analytics information.'
      ]
    },
    {
    ...
    },
    {
      ...
      {
        heading: 'To provide you with targeted promotions',
        paragraphs: [
      ...
      {
        heading: 'To protect you and the Services',
        paragraphs: [
          'We use the information we collect and receive to protect users, enforce our Terms of Service, Acceptable Use Policy, and Community Standards, and promote safety.'
        ]
      },
      {
        heading: 'To assist you with a support request',
        paragraphs: [
      ...
      {
        heading: 'To process your subscription',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          'We do not sell your personal information for monetary value. We may share personal information in accordance with your preferences, as needed to run our business and provide the Services, and where required for legal purposes.'
        ]
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'We may use the information we collect and receive about you to provide you with targeted advertising if you accept non-essential cookies using our cookie banner.'
        ]
      },
      {
      ...
      {
        heading: 'Subsidiaries and Acquirors of our Business or Assets',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          'We may preserve and share your information with third parties, including law enforcement, public or governmental agencies, or private litigants, within or outside your country of residence.'
        ]
      },
      {
      ...
      {
        heading: 'Deleting Information and Accounts and Downloading Your Data',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          'Our services are not intended for, nor directed to, children under 13 years of age.'
        ]
      },
      {
      ...
      {
        heading: 'Your Rights and Our Legal Bases',
        paragraphs: [
