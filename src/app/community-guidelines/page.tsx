...
export default function CommunityGuidelines() {
    ...
    return (
      <div>
        ...
        <Text>
          Being part of the Gradient community is a commitment to respect: we respect each other, ourselves, and the rules. These rules include Gradient's Acceptable Use Policies, along with our Terms of Service and Community Standards. When we share mutual respect, we all succeed. Here’s how we ensure that happens and what we expect from our members.
        </Text>
        </Container>
      </div>
    );
